...
cluster = MongoClient("mongodb+srv://ashiqteamsn:lNc4gwkSr6kfbO0c@cluster0.exlsq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
db = cluster["SN"]
users = db["users"]
orders = db["orders"]
